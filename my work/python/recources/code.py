...
#learned from https://www.youtube.com/watch?v=fW_OS3LGB9Q
...
რეკურსია არის საერთო მათემატიკური და პროგრამირების კონცეფცია. ეს ნიშნავს, რომ ფუნქცია თავის თავს იძახებს. ეს იმას ნიშნავს, რომ თქვენ შეგიძლიათ შეასრულოთ მონაცემები შედეგის მისაღწევად.
...
ამ მაგალითში, tri_recursion() არის ფუნქცია, რომელიც ჩვენ განვსაზღვრეთ, რომ თავად ვუწოდოთ ("recurse"). ჩვენ ვიყენებთ k ცვლადს, როგორც მონაცემს, რომელიც მცირდება (-1) ყოველ ჯერზე, როცა განმეორებით ვაკეთებთ. რეკურსია მთავრდება, როდესაც პირობა არ არის 0-ზე მეტი (ანუ როცა არის 0).

ახალ დეველოპერს შეიძლება გარკვეული დრო დასჭირდეს იმის გარკვევას, თუ როგორ მუშაობს ეს, საუკეთესო გზა ამის გასარკვევად არის მისი ტესტირება და შეცვლა.
'''
'''
მაგ:
def tri_recursion(k):
